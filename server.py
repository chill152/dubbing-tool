import os, subprocess, json, asyncio, uuid
...
# ─── BƯỚC 4: Dịch Trung → Việt bằng Gemini AI ───────────────────────
...
def dub_video():
    ...
    try:
        ...
        return jsonify({"success": True, "job_id": job_id, "output": output_path, "transcript": transcript})
